...
if __name__ == "__main__":
    # Example usage
    input_path = "/home/zhaomj/DL_project/concate_output/672_full/output_37.wav"  # Path to the input piano melody
    instrument = "drum"  # Desired accompaniment instrument
    output_path = f"/home/zhaomj/DL_project/test_track/output_37_{instrument}.wav"  # Output path for generated accompaniment
